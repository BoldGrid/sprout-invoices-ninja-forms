...
The Ninja Forms + [Sprout Invoices](https://sproutinvoices.com/?utm_medium=link&utm_campaign=free&utm_source=wordpress.org) plugin allows you to build an easy solution to creating dynamic invoices and estimates based on the prospective client’s form selections. Use Ninja Forms' product fields or Sprout Invoices' pre-defined line items to help create an estimate or invoice with the correct totals, and without you having to manage anything after submission.
...
* Remove form template that doesn't work
* Prevent huge fail
